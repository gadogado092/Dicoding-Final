...
public class ImageBannerWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "id.amat.dmovie.TOAST_ACTION";
    public static final String EXTRA_ITEM = "id.amat.dmovie.EXTRA_ITEM";
    ...
    public static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setEmptyView(R.id.stack_view, R.id.layout_empty);
